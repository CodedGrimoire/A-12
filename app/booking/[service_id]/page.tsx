      ...
      px-6 py-12">
        ...
        className="mx-auto max-w-5xl space-y-8">
          ...
          >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <label className="flex flex-col gap-2 text-sm font-medium text-slate-800">
                  ...
                  <select
                    ...
                    px-3 py-2 text-base text-slate-900 shadow-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100"
                  >
                    <option value="hours">
            ...
            className="flex flex-col gap-4 rounded-2xl border border-emerald-100
            
            
            
            bg-gradient-to-b from-emerald-50 via-white to-sky-50 p-6 shadow-inner">
              ...
              bg-white px-4 py-3 text-lg font-semibold text-slate-900 shadow">
                <span>
...
function SectionTitle({ title }: { title: string }) {
  return (
    ...
    font-semibold uppercase tracking-wide text-slate-700">
      ...
      <span className="h-6 w-0.5 rounded-full
