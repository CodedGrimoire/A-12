  ...
  return (
    ...
    >
      ...
      className="mx-auto max-w-6xl px-6">
        ...
        gap-3 sm:flex-row sm:items-end 
          ...
          className="flex items-center gap-3">
            ...
            {!hideCta ? (
              <Link
                ...
                justify-center rounded-full bg-slate-900 px-4 py-2 
                ...
                shadow-slate-300 transition hover:-translate-y-0.5 hover:bg-slate-800"
              >
                Book a caregiver
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {items.map((service) => (
            <article
              ...
              border border-slate-200 bg-white p-6 shadow-lg 
            ...
            >
              ...
              className="absolute -left-8 -top-8 h-24 w-24 
              
              
              
              rounded-full bg-emerald-100 opacity-50 blur-3xl transition 
              
              
              
              duration-700 group-hover:opacity-70" />
              ...
              className="relative space-y-3">
                ...
                className="space-y-2 text-sm text-emerald-800">
                  {service.features.slice(0, 3).map((perk) => (
                    <li
                      ...
                      gap-2 rounded-full bg-emerald-50 px-3 py-2
