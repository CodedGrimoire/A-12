...
export default function Hero() {
  ...
  return (
    <section
      id="book"
      className="relative isolate overflow-hidden px-6 pb-16 pt-12 sm:pt-20"
    >
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_20%_20%,#d9f5ff_0,transparent_32%),radial-gradient(circle_at_80%_10%,#e6fffa_0,transparent_28%),linear-gradient(180deg,#f6fbff,#ffffff)]" />
      <div className="mx-auto flex max-w-6xl flex-col gap-12 lg:flex-row lg:items-center">
        <div className="max-w-xl space-y-6">
          <div className="inline-flex items-center gap-3 rounded-full bg-white/80 px-4 py-2 text-sm font-medium text-emerald-700 shadow-sm ring-1 ring-emerald-100">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <div className="text-sm text-slate-600">
              <div className="font-semibold text-slate-900">
                Care.IO — Caregiving made easy, secure, and accessible.
              </div>
              <div className="text-emerald-700">
                বাংলা: Care.IO একটি ওয়েব অ্যাপ্লিকেশন যা ব্যবহারকারীদের শিশু,
        ...
        <div className="w-full max-w-xl">
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/70 via-white to-sky-50/70" />
            <div className="relative flex flex-col gap-6 p-8">
              ...
              <div className="grid grid-cols-2 gap-4 rounded-2xl border border-emerald-100 bg-white/70 p-4 text-sm font-medium text-slate-800 shadow-inner">
                <div className="flex flex-col gap-1">
                  <span className="text-xs uppercase tracking-wide text-emerald-600">
                    Book a visit
                  </span>
                  <span>Pick dates, share routine, confirm instantly.</span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="text-xs uppercase tracking-wide text-emerald-600">
                    Stay informed
                  </span>
                  <span>Live updates, notes, and secure chat.</span>
                </div>
              </div>
            </div>
          </div>
