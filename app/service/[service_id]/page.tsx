    ...
    <div className="min-h-screen bg-[#f6fbff] text-slate-900">
      <div className="mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl">
          <div className="bg-gradient-to-r from-emerald-50 via-white to-sky-50 px-8 py-10">
            ...
            <div className="mt-5 flex flex-wrap gap-3 text-sm text-emerald-800">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700 shadow-sm">
                ...
                <ul className="mt-2 space-y-1">
                  <li>• Share routines, medications, and emergency contacts.</li>
                  <li>• Set preferred schedule (hours or days) and location.</li>
                  <li>• Care team confirms availability before moving to confirmed status.</li>
                </ul>
              </div>
            </div>

            <div className="rounded-2xl border border-emerald-100 bg-gradient-to-b from-emerald-50 via-white to-sky-50 p-6 shadow-inner">
